  ...
  return (
    ...
    <div className="w-full h-full flex flex-col items-center justify-center bg-neutral-900">
      ...
      <div className="w-full max-w-lg bg-neutral-800 border border-neutral-700 rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-7 border-b border-neutral-700 bg-neutral-800 flex justify-center">
        ...
        <div className="p-6 flex flex-col items-center text-center space-y-8">
          ...
          <button
            ...
            className="w-full py-2 px-6 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-lg transition-colors duration-200 border border-blue-500 shadow-lg shadow-blue-900/20 flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
            Scan Current Page
          </button>

          <button onClick={()=>setState('timeline')} className="bg-blue-500 px-4 py-1 rounded-lg text-white hover:bg-blue-400">Timeline</button>

        </div>
        
        {/* Footer / Status bar */}
        <div className="px-6 py-1 bg-neutral-900/50 border-t border-neutral-700 text-center">
            <p className="text-xs text-neutral-200 uppercase tracking-widest">Ready to protect you</p>
        </div>
